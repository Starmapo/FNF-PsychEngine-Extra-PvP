...
class FunkinLua
{
	...
	public function new(script:String)
	{
		...
		Lua_helper.add_callback(lua, "doTweenX", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String)
		{
			...
			if (penisExam != null)
			{
				PlayState.instance.modchartTweens.set(tag, PlayState.instance.tweenManager.tween(penisExam, {x: value}, duration, {
		...
		Lua_helper.add_callback(lua, "doTweenY", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String)
		{
			...
			if (penisExam != null)
			{
				PlayState.instance.modchartTweens.set(tag, PlayState.instance.tweenManager.tween(penisExam, {y: value}, duration, {
					ease: getFlxEaseByString(ease),
					onComplete: function(twn:FlxTween)
					{
						PlayState.instance.callOnScripts('onTweenCompleted', [tag]);
		...
		Lua_helper.add_callback(lua, "doTweenAngle", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String)
		{
			...
			if (penisExam != null)
			{
				PlayState.instance.modchartTweens.set(tag, PlayState.instance.tweenManager.tween(penisExam, {angle: value}, duration, {
					ease: getFlxEaseByString(ease),
					onComplete: function(twn:FlxTween)
					{
						PlayState.instance.callOnScripts('onTweenCompleted', [tag]);
		...
		Lua_helper.add_callback(lua, "doTweenAlpha", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String)
		{
			...
			if (penisExam != null)
			{
				PlayState.instance.modchartTweens.set(tag, PlayState.instance.tweenManager.tween(penisExam, {alpha: value}, duration, {
					ease: getFlxEaseByString(ease),
					onComplete: function(twn:FlxTween)
					{
						PlayState.instance.callOnScripts('onTweenCompleted', [tag]);
		...
		Lua_helper.add_callback(lua, "doTweenZoom", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String)
		{
			...
			if (penisExam != null)
			{
				PlayState.instance.modchartTweens.set(tag, PlayState.instance.tweenManager.tween(penisExam, {zoom: value}, duration, {
					ease: getFlxEaseByString(ease),
					onComplete: function(twn:FlxTween)
					{
						PlayState.instance.callOnScripts('onTweenCompleted', [tag]);
		...
		Lua_helper.add_callback(lua, "noteTweenX", function(tag:String, note:Int, strumGroup:Int, value:Dynamic, duration:Float, ease:String)
		{
			...
			if (testicle != null)
			{
				PlayState.instance.modchartTweens.set(tag, PlayState.instance.tweenManager.tween(testicle, {x: value}, duration, {
					ease: getFlxEaseByString(ease),
					onComplete: function(twn:FlxTween)
					{
						PlayState.instance.callOnScripts('onTweenCompleted', [tag]);
		...
		Lua_helper.add_callback(lua, "noteTweenY", function(tag:String, note:Int, strumGroup:Int, value:Dynamic, duration:Float, ease:String)
		{
			...
			if (testicle != null)
			{
				PlayState.instance.modchartTweens.set(tag, PlayState.instance.tweenManager.tween(testicle, {y: value}, duration, {
					ease: getFlxEaseByString(ease),
					onComplete: function(twn:FlxTween)
					{
						PlayState.instance.callOnScripts('onTweenCompleted', [tag]);
		...
		Lua_helper.add_callback(lua, "noteTweenAngle", function(tag:String, note:Int, strumGroup:Int, value:Dynamic, duration:Float, ease:String)
		{
			...
			if (testicle != null)
			{
				PlayState.instance.modchartTweens.set(tag, PlayState.instance.tweenManager.tween(testicle, {angle: value}, duration, {
					ease: getFlxEaseByString(ease),
					onComplete: function(twn:FlxTween)
					{
						PlayState.instance.callOnScripts('onTweenCompleted', [tag]);
		...
		Lua_helper.add_callback(lua, "noteTweenAlpha", function(tag:String, note:Int, strumGroup:Int, value:Dynamic, duration:Float, ease:String)
		{
			...
			if (testicle != null)
			{
				PlayState.instance.modchartTweens.set(tag, PlayState.instance.tweenManager.tween(testicle, {alpha: value}, duration, {
					ease: getFlxEaseByString(ease),
					onComplete: function(twn:FlxTween)
					{
						PlayState.instance.callOnScripts('onTweenCompleted', [tag]);
		...
		Lua_helper.add_callback(lua, "noteTweenDirection", function(tag:String, note:Int, strumGroup:Int, value:Dynamic, duration:Float, ease:String)
		{
			...
			if (testicle != null)
			{
				PlayState.instance.modchartTweens.set(tag, PlayState.instance.tweenManager.tween(testicle, {direction: value}, duration, {
					ease: getFlxEaseByString(ease),
					onComplete: function(twn:FlxTween)
					{
						PlayState.instance.callOnScripts('onTweenCompleted', [tag]);
		...
		{
			cancelTimer(tag);
			PlayState.instance.modchartTimers.set(tag, new FlxTimer(PlayState.instance.timerManager).start(time, function(tmr:FlxTimer)
			{
				if (tmr.finished)

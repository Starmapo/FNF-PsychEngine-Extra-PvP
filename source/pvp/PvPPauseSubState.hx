...
class PvPPauseSubState extends MusicBeatSubState
{
	...
	override function update(elapsed:Float)
	{
		...
		if (gamepad != null)
		{
			if (gamepad.justPressed.LEFT_STICK_DIGITAL_UP || gamepad.justPressed.DPAD_UP)
				upP = true;
			if (gamepad.justPressed.LEFT_STICK_DIGITAL_DOWN || gamepad.justPressed.DPAD_DOWN)
				downP = true;
			if (gamepad.pressed.LEFT_STICK_DIGITAL_UP || gamepad.pressed.DPAD_UP)
				up = true;
			if (gamepad.pressed.LEFT_STICK_DIGITAL_DOWN || gamepad.pressed.DPAD_DOWN)
				down = true;

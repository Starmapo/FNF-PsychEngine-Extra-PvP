...
class Paths
{
	...
	public static var ignoreLibraries:Array<String> = ['default', 'shared', 'songs', 'videos'];
	...
	inline static public function getPackerAtlas(key:String, ?library:String)
	{
		...
		return FlxAtlasFrames.fromSpriteSheetPacker((imageLoaded != null ? imageLoaded : image(key, library)),
			getContent(file('images/$key.txt', TEXT, library)));
	}
	...
	inline static public function getTexturePackerAtlas(key:String, ?library:String)
	{
		...
		return FlxAtlasFrames.fromTexturePackerJson((imageLoaded != null ? imageLoaded : image(key, library)),
			getContent(file('images/$key.json', TEXT, library)));
	}

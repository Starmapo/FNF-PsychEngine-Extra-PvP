...
class FunkinHscript extends InterpEx
{
	...
	public function new(path:String)
	{
		...
		// EVENTS
		var funcs = [
			'onCreate', 'onCreatePost', 'onDestroy', 'onStepHit', 'onBeatHit', 'onStartCountdown', 'onSongStart', 'onEndSong', 'onSkipCutscene',
			'onBPMChange', 'onSignatureChange', 'onOpenChartEditor', 'onOpenCharacterEditor', 'onPause', 'onResume', 'onGameOver', 'onRecalculateRating'
		];
		for (i in funcs)

...
class Controls extends FlxActionSet
{
	...
	public function addDefaultGamepad(id):Void
	{
		...
		addGamepad(id, [
			...
			Control.NOTE_LEFT => [DPAD_LEFT, LEFT_STICK_DIGITAL_LEFT, RIGHT_STICK_DIGITAL_LEFT, LEFT_TRIGGER],
			Control.NOTE_DOWN => [DPAD_DOWN, LEFT_STICK_DIGITAL_DOWN, RIGHT_STICK_DIGITAL_DOWN, LEFT_SHOULDER],
			Control.NOTE_UP => [DPAD_UP, LEFT_STICK_DIGITAL_UP, RIGHT_STICK_DIGITAL_UP, RIGHT_SHOULDER],
			Control.NOTE_RIGHT => [DPAD_RIGHT, LEFT_STICK_DIGITAL_RIGHT, RIGHT_STICK_DIGITAL_RIGHT, RIGHT_TRIGGER],
			Control.PAUSE => [START],
			Control.RESET => [8]
		]);
		#else
